...
#define ERR_WIN_HTTP_FREE_LIBRARY (0xE200FF01|ERR_FLAG_CAN_IGNORE)
#define ERR_WIN_HTTP_CLOSE_MUTEX  (0xE200FF02|ERR_FLAG_CAN_IGNORE)
#define ERR_WIN_HTTP_RECOVER_INST (0xE200FF03|ERR_FLAG_CAN_IGNORE)
