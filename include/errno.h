...
#define ERR_RUNTIME_LOCK_EVENT          (0x01000203)
#define ERR_RUNTIME_UNLOCK_EVENT        (0x01000204)
#define ERR_RUNTIME_NOTICE_TRIGGER      (0x01000205)
#define ERR_RUNTIME_WAIT_TRIGGER        (0x01000206)
#define ERR_RUNTIME_RESET_EVENT         (0x01000207)
#define ERR_RUNTIME_DEFENSE_RT          (0x01000208)
#define ERR_RUNTIME_FLUSH_INST_CACHE    (0x01000209)
