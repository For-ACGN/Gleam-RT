...
#define ERR_RUNTIME_UNLOCK_LIBRARY  (0xFF000208)
#define ERR_RUNTIME_UNLOCK_MEMORY   (0xFF000209)
#define ERR_RUNTIME_UNLOCK_THREAD   (0xFF00020A)
#define ERR_RUNTIME_UNLOCK_RESOURCE (0xFF00020B)
#define ERR_RUNTIME_UNLOCK_ARGUMENT (0xFF00020C)
...
#define ERR_WIN_FILE_INIT_API     (0xE1000001)
#define ERR_WIN_FILE_UPDATE_PTR   (0xE1000002)
#define ERR_WIN_FILE_INIT_ENV     (0xE1000003)
#define ERR_WIN_FILE_RECOVER_INST (0xE100FF01|ERR_FLAG_CAN_IGNORE)

#define ERR_WIN_HTTP_INIT_API     (0xE2000001)
#define ERR_WIN_HTTP_UPDATE_PTR   (0xE2000002)
#define ERR_WIN_HTTP_INIT_ENV     (0xE2000003)
#define ERR_WIN_HTTP_RECOVER_INST (0xE200FF01|ERR_FLAG_CAN_IGNORE)
