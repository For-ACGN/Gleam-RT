...
#define ERR_RUNTIME_CLEAN_H_MUTEX_SLEEP   (0x0100FF03)
#define ERR_RUNTIME_CLEAN_H_EVENT_ARRIVE  (0x0100FF04)
#define ERR_RUNTIME_CLEAN_H_EVENT_DONE    (0x0100FF05)
#define ERR_RUNTIME_CLEAN_H_MUTEX_EVENT   (0x0100FF06)
#define ERR_RUNTIME_CLEAN_H_EVENT_HANDLER (0x0100FF07)
#define ERR_RUNTIME_CLEAN_FREE_MEM        (0x0100FF08)
#define ERR_RUNTIME_EXIT_RECOVER_INST     (0x0100FF09)
