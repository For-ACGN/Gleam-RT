...
static bool TestRuntimeMemory(Runtime_M* runtime)
{
    ...
    uint64* test1 = (uint64*)runtime->Alloc(sizeof(uint64));
    if (test1 == NULL)
    {
        return -1;
    }
    *test1 = 0x1234567812345600;
    ...
    uint64* test2 = (uint64*)runtime->Alloc(sizeof(uint64));
    if (test2 == NULL)
    {
        return -1;
    }
    *test2 = 0x1234567812345601;
    ...
    uint64* test3 = (uint64*)runtime->Alloc(sizeof(uint64));
    if (test3 == NULL)
    {
        return -1;
    }
    *test3 = 0x1234567812345602;
    ...
    uint64* test4 = (uint64*)runtime->Alloc(sizeof(uint64));
    if (test3 == NULL)
    {
        return -1;
    }
    *test4 = 0x1234567812345603;
    ...
    if (!runtime->Free(test3))
    {
        return -1;
    }
    if (!runtime->Free(test1))
    {
        return -1;
    }
    uint64* test5 = (uint64*)runtime->Alloc(sizeof(uint64));
    if (test5 == NULL)
    {
        return -1;
    }
    *test5 = 0x1234567812345600;
    ...
    if (!runtime->Free(test2))
    {
        return -1;
    }
    if (!runtime->Free(test4))
    {
        return -1;
    }
    if (!runtime->Free(test5))
    {
        return -1;
    }
